 ...
 <div class = "fixed">
  ...
  <section class = "top-bar-section">
     <?php if ($user): ?>
      ...
      <ul class = "center"> 
        <li class = "active"><a href="photos.php">Comments</a></li>
      </ul>
      <ul class = "center"> 
        <li class = "active"><a href="photos.php">Likes</a></li>
      </ul>
  <?php $total = count($ret_obj);
       $totalcomment = count($ret_obj4);
       $photo = ($ret_obj3[0]);
       $comments = $ret_obj4;
    ...
    <div class="large-12 columns">
      ...
      <!-- Feed Entry -->
       <?php
          ...
          <div class="row">
              <div class="large-2 columns small-3"><img src="<?php echo $photo['url'];?>" /></div>
              <div class="large-10 columns">
               <p><strong><?php echo $user_profile["name"]; ?>: </strong> <?php echo $product["message"]; ?></p>
