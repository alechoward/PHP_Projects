            ...
            <section>
              ...
              <div class="content" data-slug="category" data-section-content>
                <ul class="inline-list"> <!--refer to inline-list in .css file to see how the list is centered with additon of 'display: inline-block' feature and removal of float:left -->
                   <li><a href="browseshopclickableelementnewtest.php?var=flowersrs"><em><p>Flower and Shell People</p></em></a></li>
                   <li><a href="browseshopclickableelementnewtest.php?var=chinosieresr"><em><p>Chinosieres</p></em></a></li>
                   <li><a href="browseshopclickableelementnewtest.php?var=shellsrs"><em><p>Shells</p></em></a></li>
                   <li><a href="browseshopclickableelementnewtest.php?var=gardensrs"><em><p>Gardens</p></em></a></li>
                   <li><a href="browseshopclickableelementnewtest.php?var=miscellaneousrs"><em><p>Miscellaneous</p></em></a></li>
                </ul>
              </div>
            </section>
        </div>
